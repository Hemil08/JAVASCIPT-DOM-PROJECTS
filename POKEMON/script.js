...
const pockedex = document.getElementById('pokedex');
...
function createPokemonCard(pokemon){
    ...
    frontPokeID.textContent = `${pokemon.id}`
    ...
    backImage.classList.add("back-position-image")
